...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'puppy.sqlite')
...
class Puppy(db.Model):
    ...
    # Assumption of 1 dog per 1 owner and vice versa.
    owner = db.relationship('Owner',backref='puppy',uselist=False)

    def __init__(self,name):
        # A puppy only needs to be initalized with a name!
        self.name = name
